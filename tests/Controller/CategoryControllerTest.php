...
class CategoryControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'category[assigned]' => 'Testing',
            'category[activity]' => 'Testing',
            'category[id]' => 'Testing',
            'category[createdAt]' => 'Testing',
            'category[updatedAt]' => 'Testing',
            'category[categoryGroup]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setCategoryGroup('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $fixture->setCategoryGroup('Value');
        ...
        $this->client->submitForm('Update', [
            ...
            'category[assigned]' => 'Something New',
            'category[activity]' => 'Something New',
            'category[id]' => 'Something New',
            'category[createdAt]' => 'Something New',
            'category[updatedAt]' => 'Something New',
            'category[categoryGroup]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getCategoryGroup());
    }
